...
function BuyDash(props) {
  ...
  async function Buy(price) {
    ...
    const amountInWei = web3.utils.toWei(price, "wei"); // Amount to send in wei
  ...
  async function BuySkin(event,id){
        ...
        //skin with skin id -> get skin price from 

        try {
            const url = `http://localhost:5001/Ajitesh/Buy/${skinId}`;
